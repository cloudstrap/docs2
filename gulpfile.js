...
// Deletes the directory that is used to public the site during development
gulp.task("clean:dev", del.bind(null, ["public"]));
...
gulp.task("copy", function () {
  return gulp.src(["public/*.txt", "public/*.xml"])
    .pipe(gulp.dest("site"))
...
// between them.
gulp.task("public:dev", ["styles", "jekyll:dev"], function () {
  bs = browserSync({
    notify: true,
    // tunnel: "",
    server: {
...
gulp.task("watch", function () {
  ...
  gulp.watch(["public/assets/stylesheets/*.css"], reload);
...
gulp.task("default", ["public:dev", "watch"]);
